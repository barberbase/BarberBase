...
<div class="min-h-screen bg-slate-950 text-slate-100 flex flex-col justify-center items-center p-4 font-sans selection:bg-amber-500 selection:text-slate-950">
	<!-- Background Decorative Gradients -->
	<div class="absolute inset-0 overflow-hidden pointer-events-none">
		<div class="absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] rounded-full bg-amber-500/10 blur-[120px]"></div>
		<div class="absolute bottom-1/4 left-1/3 w-[400px] h-[400px] rounded-full bg-blue-500/5 blur-[100px]"></div>
	</div>

	<!-- Login Card -->
	<div class="relative w-full max-w-md bg-slate-900/60 backdrop-blur-xl border border-slate-800/80 rounded-3xl p-8 shadow-2xl space-y-8">
		<!-- Header -->
		...
		{#if step === 'phone'}
			...
			>
				<div class="space-y-2">
					<label for="phone_number" class="block text-xs font-semibold text-slate-400 uppercase tracking-wider">
			...
			>
				...
				<div class="space-y-2">
					<div class="flex justify-between items-center">
						<label for="otp" class="block text-xs font-semibold text-slate-400 uppercase tracking-wider">
							Enter 6-Digit OTP
						</label>
